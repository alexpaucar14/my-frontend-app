          ...
          <li className="side-nav-item">
            ...
            <div className="collapse" id="sidebarLayouts">
              <ul className="side-nav-second-level">
                ...
                <li>
                  <a href="layouts-full.html" target="_blank">
                    Full View
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="layouts-hover.html" target="_blank">
                    Hover Menu
                  </a>
                </li>
                <li>
                  <a href="layouts-compact.html" target="_blank">
                    Compact
                  </a>
                </li>
                <li>
                  <a href="layouts-icon-view.html" target="_blank">
                    Icon View
                  </a>
                </li>
              </ul>
